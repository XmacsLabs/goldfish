...
(timing "rich-integer%to-string:\t\t" (lambda () (repeat 100000 (lambda () ((rich-integer 65536) :to-string)))))
(timing "rich-integer2%to-string:\t" (lambda () (repeat 100000 (lambda () ((rich-integer2 65536) :to-string)))))
(timing "rint%to-string:\t\t\t" (lambda () (repeat 100000 (lambda () ((rint 65536) :to-string)))))
(timing "rich-integer-s7%to-string:\t" (lambda () (repeat 100000 (lambda () ((rich-integer-s7 65536) :to-string)))))

(display* ((rint 65535) :to-string))
(newline)

(display* "\n\nBench of SQRT:\n")
(timing "prim%sqrt:\t\t\t" (lambda () (repeat 100000 (lambda () (prim-sqrt 65536)))))
(timing "rint%sqrt:\t\t\t" (lambda () (repeat 100000 (lambda () ((rint 65536) :sqrt)))))
(timing "rint-lambda%sqrt:\t\t" (lambda () (repeat 100000 (lambda () ((rint-lambda 65536) :sqrt)))))
