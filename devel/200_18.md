...
## 2025-10-27 xmake target 安装目录 goldfish/guenchi

### What

xmake target 安装目录 goldfish/guenchi

### Why

goldfish target 缺少 `goldfish/guenchi` 目录的安装。

### How

在 xmake.lua 中为 goldfish target 添加 `goldfish/guenchi` 目录的安装。
